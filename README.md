# ConceptBox
ConceptBox is a very simple React Native app designed to create a list of 'concepts' based on text entered by a user.  Each 'concept' card can be deleted anytime after being added.
...
[Expo updating docs](https://docs.expo.io/versions/latest/workflow/upgrading-expo/)
...
## This README relied upon sanity-io's extensive and excellent [Set Up](https://github.com/sanity-io/example-app-react-native/blob/master/README.md) docs.